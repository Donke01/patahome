...
const AREAS = [
  ...
  // --- Nationwide coverage: every county HQ + popular rental neighbourhoods.
  // Coordinates are approximate town centres (used for "nearest to you" sorting).
  ["Kileleshwa, Nairobi","Nairobi",-1.2833,36.7833],
  ["Lavington, Nairobi","Nairobi",-1.2780,36.7700],
  ["Karen, Nairobi","Nairobi",-1.3197,36.7073],
  ["Lang'ata, Nairobi","Nairobi",-1.3380,36.7650],
  ["Parklands, Nairobi","Nairobi",-1.2600,36.8150],
  ["Embakasi, Nairobi","Nairobi",-1.3170,36.8940],
  ["Donholm, Nairobi","Nairobi",-1.2960,36.8900],
  ["Umoja, Nairobi","Nairobi",-1.2830,36.8990],
  ["Roysambu, Nairobi","Nairobi",-1.2170,36.8850],
  ["Kahawa West, Nairobi","Nairobi",-1.1850,36.8950],
  ["Githurai","Kiambu",-1.2000,36.9150],
  ["Kiambu Town","Kiambu",-1.1714,36.8356],
  ["Kikuyu","Kiambu",-1.2460,36.6630],
  ["Juja","Kiambu",-1.1020,37.0140],
  ["Kitengela","Kajiado",-1.4760,36.9600],
  ["Ongata Rongai","Kajiado",-1.3960,36.7440],
  ["Kajiado Town","Kajiado",-1.8520,36.7760],
  ["Mlolongo","Machakos",-1.3930,36.9430],
  ["Machakos Town","Machakos",-1.5177,37.2634],
  ["Mombasa CBD","Mombasa",-4.0435,39.6682],
  ["Bamburi","Mombasa",-3.9960,39.7200],
  ["Mtwapa","Kilifi",-3.9420,39.7450],
  ["Kilifi Town","Kilifi",-3.6305,39.8499],
  ["Malindi","Kilifi",-3.2192,40.1169],
  ["Diani","Kwale",-4.3160,39.5690],
  ["Kwale Town","Kwale",-4.1737,39.4521],
  ["Voi","Taita Taveta",-3.3961,38.5561],
  ["Lamu Town","Lamu",-2.2717,40.9020],
  ["Hola","Tana River",-1.4990,40.0300],
  ["Garissa Town","Garissa",-0.4532,39.6461],
  ["Wajir Town","Wajir",1.7471,40.0573],
  ["Mandera Town","Mandera",3.9373,41.8569],
  ["Marsabit Town","Marsabit",2.3350,37.9900],
  ["Isiolo Town","Isiolo",0.3546,37.5822],
  ["Meru Town","Meru",0.0471,37.6498],
  ["Chuka","Tharaka-Nithi",-0.3330,37.6456],
  ["Embu Town","Embu",-0.5389,37.4596],
  ["Kitui Town","Kitui",-1.3667,38.0167],
  ["Wote","Makueni",-1.7833,37.6333],
  ["Nyeri Town","Nyeri",-0.4201,36.9476],
  ["Karatina","Nyeri",-0.4830,37.1270],
  ["Murang'a Town","Murang'a",-0.7210,37.1526],
  ["Kerugoya","Kirinyaga",-0.4989,37.2803],
  ["Nanyuki","Laikipia",0.0167,37.0740],
  ["Nyahururu","Laikipia",0.0381,36.3629],
  ["Ol Kalou","Nyandarua",-0.2700,36.3780],
  ["Naivasha","Nakuru",-0.7167,36.4333],
  ["Narok Town","Narok",-1.0833,35.8667],
  ["Kericho Town","Kericho",-0.3677,35.2831],
  ["Bomet Town","Bomet",-0.7813,35.3416],
  ["Kapsabet","Nandi",0.2039,35.1053],
  ["Iten","Elgeyo-Marakwet",0.6703,35.5081],
  ["Kabarnet","Baringo",0.4919,35.7430],
  ["Maralal","Samburu",1.0967,36.6981],
  ["Kapenguria","West Pokot",1.2389,35.1119],
  ["Lodwar","Turkana",3.1191,35.5973],
  ["Kakamega Town","Kakamega",0.2827,34.7519],
  ["Bungoma Town","Bungoma",0.5635,34.5606],
  ["Webuye","Bungoma",0.6070,34.7700],
  ["Busia Town","Busia",0.4608,34.1115],
  ["Mbale, Vihiga","Vihiga",0.0833,34.7167],
  ["Kisii Town","Kisii",-0.6817,34.7667],
  ["Nyamira Town","Nyamira",-0.5633,34.9358],
  ["Homa Bay Town","Homa Bay",-0.5273,34.4571],
  ["Migori Town","Migori",-1.0634,34.4731],
  ["Siaya Town","Siaya",0.0612,34.2881],
  ["Bondo","Siaya",-0.0940,34.2750]
];
